...
git clone https://github.com/StentorTechnology/stentor-examples.git
chown -R ubuntu:ubuntu /home/ubuntu/stentor-examples
ln -s stentor-examples/single-node/node .

# done!
echo
banner "Stentor"
echo
echo 'The Stentor vagrant instance has been provisioned. Core cluster setup is at the 'node' directory inside the instance.'
